...
const char *const html =
    ...
    "`${h}%`; document.getElementById(\"luminosity\").nodeValue = `${l}/4095`; } "
    "document.addEventListener(\"DOMContentLoaded\", () => { setTimeout(async () => { await updateSensorData(); "
    "setInterval(updateSensorData, 30000); }, 3000); }); </script></body></html>";