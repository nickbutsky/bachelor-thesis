...
const char *const htmlTemplate =
    ...
    ".i { justify-content: space-between; padding: 8px 0; border-bottom: 1px solid #eee; } .f { display: flex; } "
    "</style></head><body><div class=\"f\" style=\"margin-top: 10vh; justify-content: center\"><div style=\"width: "
    "300px\"><div class=\"i f\"><strong>Температура</strong><div id=\"t\" class=\"f\"></div></div><div class=\"i "
    "f\"><strong>Вологість</strong><div id=\"h\" class=\"f\"></div></div><div class=\"i "
    "f\"><strong>Освітленість</strong><div class=\"f\"><div id=\"l\"></div> lx </div></div><div id=\"st\" "
